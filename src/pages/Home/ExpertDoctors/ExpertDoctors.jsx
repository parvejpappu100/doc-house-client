    ...
    return (
        <div className='max-w-[1140px] mx-auto px-4 mb-28'>
            ...
            <div className='my-24 grid grid-cols-1 md:grid-cols-3 gap-10'>
                {
                    doctors?.map(doctor => <div key={doctor._id} className='border-2 p-5 rounded-lg'>
                        <div>
                            ...
                            <button className='w-full border border-[#F7A582] rounded-md py-3 font-semibold text-[#F7A582] text-xl hover:text-white hover:bg-[#F7A582] duration-500 '>View Profile</button>
                        </div>
                    </div>)
                }
            </div>
